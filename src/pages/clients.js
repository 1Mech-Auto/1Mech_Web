...
const Clients = () => {
  ...
  return (
    <Layout>
      ...
      <div className="bg-white min-h-[85vh] overflow-x-auto p-6">
        ...
        <div className="border rounded-md min-h-[30vh] overflow-x-auto ">
          <main className="font-semibold text-gray-400 text-sm grid grid-cols-[3%,25%,23%,12%,7%,12%,10%,4%] p-2.5 border border-transparent border-b-gray-200 gap-2">
            <div>#</div>
            <div>Client</div>
            <div>Email</div>
            <div>Balance</div>
          ...
          <div className="font-medium text-gray-400 text-sm grid grid-cols-[3%,25%,23%,12%,7%,12%,10%,4%] items-center p-2.5 border border-transparent border-b-gray-200 gap-2 hover:shadow-hoverPurple">
            <div>1</div>
            <div className="flex items-center gap-2">
