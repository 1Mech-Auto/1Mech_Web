          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                autoComplete="email"
                required
                className="block w-full rounded-md border-0 py-2 outline-[#0971fe] text-[#344357] shadow-sm ring-1 ring-inset ring-[#0971fe1a] placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-[#0971fe1a] sm:text-sm sm:leading-7"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                required
                className="block w-full rounded-md border-0 py-2 outline-[#0971fe] text-[#344357] shadow-sm ring-1 ring-inset ring-[#0971fe1a] placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0971fe1a] sm:text-sm sm:leading-7"
              />
            </div>
          </div>
