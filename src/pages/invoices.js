    ...
    <Layout>
      ...
      <section className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400 ">A total of 2 invoices.</p>
        </div>
      ...
      <div className="bg-white min-h-[85vh] p-6">
        ...
        <div className="border rounded-md min-h-[30vh] overflow-x-auto ">
          <main className="font-semibold text-gray-400 text-sm grid grid-cols-[3%,25%,13%,10%,14%,12%,10%,5%] p-2.5 border border-transparent border-b-gray-200 gap-2">
            <div>#</div>
            <div>Client</div>
            <div>Project</div>
            <div>Items</div>
          ...
          <div className="font-medium text-gray-400 text-sm grid grid-cols-[3%,25%,13%,10%,14%,12%,10%,5%] items-center p-2.5 py-4 border border-transparent border-b-gray-200 gap-2 hover:shadow-hoverPurple">
            <div>1</div>
            <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-medium text-black">9 41</h3>
